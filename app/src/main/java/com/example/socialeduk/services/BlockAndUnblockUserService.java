...
public class BlockAndUnblockUserService {

    public APIEnv env = new APIEnv();
    private RequestQueue _queue;

    public BlockAndUnblockUserService(RequestQueue queue) {
        this._queue = queue;
    }

    public void block(BlockAndSendFriendRequest request, VolleyCallBack callback)throws JSONException {
    ...
    public void unblock(BlockAndSendFriendRequest request, VolleyCallBack callback)throws JSONException {
        String url = env.getURI() + "/users/unblockUser";
